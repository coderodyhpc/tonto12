...
#                    truelat1, truelat2, stand_lon) -> None:
    def set_domains(self, map_proj: str=[],
        ...
        self.aaa = center_lonlat.lon
        self.bbb = center_lonlat.lat
        print ("LONLAT ",center_lonlat,self.aaa,self.bbb)
        self.data['domains'] = [{
            "map_proj": map_proj,
#            "center_lonlat" : [center_lonlat.lon, center_lonlat.lat],
            "center_lonlat" : [self.aaa, self.bbb],
...
#        print ("At fill domains ",domains[0])
    ...
    def update_wps_namelist(self):
        ...
        print ("It's at update_wps_namelist 1 ")
        self.fill_domains()
        wps = convert_project_to_wps_namelist(self)

        print ("It's at update_wps_namelist 2 ")
...
#___ Preparation of namelist.input                    
    def prepare_wrf_run(self, wrf_folder: str) -> None:
        print ("@ prepare_wrf_run ",wrf_folder)
