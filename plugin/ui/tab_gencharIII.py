...
#        layout.addWidget(GFScall,5,0)
        ...
        layout.addWidget(self.bl_8,7,0)
...
#        gfs = WhiteScroll(GFSToolsDownloadManager(iface))
...
#        aux = Tempus()
        print ("PROJECT REFRESH2 \n",self.project)
#        self.dies_tetra.setDisabled(True)
#        self.bl_8.setDisabled(True)
#        self.bl_8.setStyleSheet("background-color:#880000; color:black");
