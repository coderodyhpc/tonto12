...
#        layout.addWidget(self.nuntisI)
        ...
        self.valorem.setFont(QFont('Verdana', 14))
        ...
        nuntiumD.setFont(QFont('Verdana', 14))
        ...
        self.valorem2.setFont(QFont('Verdana', 14))
...
#                              "ap-southeast-2","ap-northeast-1","af-south-1","ap-east-1"])
        ...
        self.ahaha.setFont(QFont('Verdana', 16))
...
#    def __init__(self, parent, pepe):           # nuntium and spatium are used to hold the Label and Combo content
    def __init__(self, parent):           # nuntium and spatium are used to hold the Label and Combo content
        super().__init__(parent)
#        self.region = pepe
#        self.region = S3_controller.chorda_meus(self)
#        print ("REGION @ BUCKET ", self.region, pepe)
        layout = QHBoxLayout()
    ...
    def bucket_creation(self):         # I cannot include other variables so 'region' & 'bucket_name' must be predetermined
        self.region = S3_controller.chorda_meus(self)
        print ('BUCKET CREATION ',bucket_name)
#        region = self.cred3
...
#                                    CreateBucketConfiguration=location)
                self.nomen = QInputDialog.getText(self, 'Enter bucket name:')
                s3_client = boto3.client('s3', region_name=self.region)
                location = {'LocationConstraint': self.region}
                s3_client.create_bucket(Bucket=self.nomen
                                    ,CreateBucketConfiguration=location)
...
#        text2 = """
#                    <html>
#                        NOTE: The AWS key must\n  
#                        </p>
#                    </html>
#               """
#        label_text2 = QLabel(text2)
#        label_text2.setWordWrap(True)
#        label_text2.setFont(QFont('Verdana', 10))
...
#___ Block 1: Are CREDENTIALS AVAILABLE ___#
        block5 = QHBoxLayout()
        self.block1 = "            "
...
#___ Block 5: S3 transfer ___#
        self.widget4 = Aws_transfer(self)
...
#              print ("SITULA is empty ")
    ...
    def chorda_meus(self):
#        print ("AT CHORDA MEUS ",self.chorda)
        return self.chorda.partition("region = ")[2]  
