...
class ViewWidget(QWidget):
    ...
    def __init__(self, iface, dock_widget: QDockWidget) -> None:
        ...
        dir_path = '/home/ubuntu/WRF-4.4/test/em_real'
        res = []
# Iterate directory
...
##        self.add_dataset('/home/ubuntu/WRF-4.4/test/em_real')
        for file in res:
            wrfout_file = '/home/ubuntu/WRF-4.4/test/em_real/'+file
#            print ("File one-by-one ",wrfout_file)
            self.add_dataset(wrfout_file)
#        print("FILES ",res)
#        self.add_dataset('/home/ubuntu/WRF-4.4/test/em_real')
...
#        print ("@ADD DATASET dataset_name ",extra_dims,dataset_name,"\n")
